...
export const GoogleButton = ({ children} : {
    ...
    return (
        <button className="flex justify-center items-center rounded-lg bg-[#007dc1] py-1 pl-1 pr-2.5 text-xs font-semibold text-white shadow-[0px_0px_40px_rgba(0,0,0,0.06)] hover:bg-[#016398] active:bg-[#014b75] mobile:h-11 sm:text-base">
